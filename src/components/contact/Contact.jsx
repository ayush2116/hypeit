...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_t2udwq7', 'template_gnfjhqr', form.current, '97f4XGzJyhi7tz00e')
      e.target.reset();
  };
  return (
    <section className="contact section" id="contact">
      ...
      <div className="contact__container grid">
        <div className="contact__content ">
          <h3 className="contact__title">Talks to Us</h3>
          <div className="contact__info">
            <div className="contact__card">
              <i className="bx bx-mail-send contact__card-icon"></i>
              <h3 className="contact__card-title">Email</h3>
              <span className="contact__card-data">hypeitupofficial.in@gmail.com</span>
            ...
            {/* <div className="contact__card">
              ...
              <a
                href="https://www.urbandictionary.com/define.php?term=chutiyapa"
                className="contact__cutton"
              >
                Write Us
                <i className="bx bx-right-arrow-alt contact__button-icon"></i>
              </a>
        ...
        <div className="contact__content">
          ...
          <form ref={form} onSubmit={sendEmail} className="contact__form">
            ...
            <div className="contact__form-div">
              <label className="contact__form-tag">Mail Me</label>
              <input
                type="email"
                name="email"
                className="contact__form-input"
