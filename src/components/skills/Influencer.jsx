...
const Influencer = () => {
  return (
    <div className="skills__content">
        <h3 className="skills__title">Influencer identification and selection</h3>
            <div className="skills__box">
                <div className="skills__group">
                    ...
                    <div>
                        ...
                        <span className="skills__level">We can help brands identify influencers who are a good fit for their target market and align with their brand values</span>
                    </div>
                    {/* </div>
                    <div className="skills__data">
                    <i class='bx bx-badge-check'></i>
